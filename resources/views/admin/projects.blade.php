...
<div class="container-fluid">
    ...
    <div class="align">
        ...
        <div>
            <form method="GET" action="{{route('projects')}}" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                <div class="input-group">
                    <input type="text" class="form-control bg-light border-0 small" name="search" value="{{request()->query('search')}}" placeholder="Name"
            ...
            <div class="table-responsive my-2">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        @endforelse
                        <tr>
                            <td colspan="4">{{$projects->appends(['search' => request()->query('search')])->links()}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
