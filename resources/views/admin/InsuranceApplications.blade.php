...
<div class="container-fluid">
    ...
    <div class="align">
        ...
        <div>
            <form method="GET" action="{{route('insuranceApplications')}}" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            ...
            <div class="table-responsive my-2">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                       ...
                       @endforelse
                        <tr>
                            <td colspan="6">{{$insuranceApplications->appends(['search' => request()->query('search')])->links()}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
